<?php 
define ('PAGE_TITLE', 'HappyJapan USA'); 
...
<!-- Main Content Starts Here -->
    <div class="container main-content">
        <div class="row">
            ...
            <div class="col-12 pb-5">
                <h2>Unrivaled Efficiency</h2>
                <p class="promotext">Matched against the competition, HappyJapan models are 50% more productive. Maintain high production levels all year long with 24/7 countiuous operation for all models.</p>
             <!--   <h2>Modern</h2>
            ...
            <div class="col-5">
                <img class="text-center" src="./images/warranty.png" alt="">
            </div>
            <div class="col-12 pb-5">
                <h2>Maximum Reliability</h2>
                <p class="promotext">Japanese design ensures that every machine is manufactured to the highest quality standards with Heavy-Duty components.</p>
